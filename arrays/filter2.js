...
.includes(str.toLowerCase()) || utilisateur.UserName.toLowerCase()
.includes(str.toLowerCase()) || utilisateur.Email.toLowerCase()
.includes(str.toLowerCase()) || utilisateur.AccessLevel.toLowerCase()
